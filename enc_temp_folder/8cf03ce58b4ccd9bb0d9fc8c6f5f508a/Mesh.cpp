...
void Mesh::Create(Shader* _shader) {
	...
	m_texture = Texture();
	m_texture.LoadTexture("Res/box-alpha.png");
...
{
	// Transformation
	mat4 rotate = glm::rotate(glm::mat4(1.f), (float)glfwGetTime(), glm::vec3(0.f, 1.f, 0.f)); 
	//m_world = glm::translate(glm::mat4(1.f), glm::vec3(glm::sin(glfwGetTime()), 0.f, 0.f)); 
	m_world = rotate;
